...
(function (q, g) {
  ...
  var q = function (g, u) {
    function C() {
      if (
        ...
        var f = !0,
          c = !0,
          b;
          //quantity count and remove or add //
    ...
    //2nd object create new (Local)//
    var a = Object.create(q.prototype),
      l = 0,
      v = 0,
      m = 0,         //price add imedietly//
      n = 0,
      d = [],
      w = !0,
      A =
        ...
        function (a) {
          return setTimeout(a, 1e3 / 60);//time set and payment than remove//
        },
      p = null,
      x = !1;
      //error check//
    ...
    var D = // count animationn are created here//
      ...
      E =
        ...
        // here we set different value of a//
    a.options = { 
      speed: -2,
      verticalSpeed: null,
    ...
    //create object and animation kemon hbe tah//
    u &&
        ...
        B = function () {
          ...
          for (f = 0; f < a.elems.length; f++) {
            var c = void 0,
              ...
              r = !0;
              //size er jnno variable attributes//
...
//scroll up down left rigth//
        ...
        //again new product variable create//
        H = function () {
          var d = l,
            c = m;
          l = a.options.wrapper
        ...
        //use for loop for increase product in the product// 
        K = function () {
        ...
        //css theke connection niya kaj krtase//
      a.destroy = function () {
